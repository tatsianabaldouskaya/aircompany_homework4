...
namespace AircompanyTests.Tests
{
    ...
    public class AirportTests
    {
        ...
        private PassengerPlane _passengerPlaneWithMaxPassengerCapacity = new PassengerPlane("Boeing-747", 980, 16100, 70500, 242);
        ...
        [Test]
        public void IsExpectedPlaneWithMaxPassengersCapacityEqualsActual()
        {
            Airport airport = new Airport(planes);
