...
namespace AircompanyTests.Tests
{
    ...
    public class AirportBaseTests
    {
        ...
        protected PassengerPlane _passengerPlaneWithMaxPassengerCapacity = new PassengerPlane(new Plane("Boeing-747", 980, 16100, 70500), 242);

        
        public bool HasMilitaryTransportPlanes()
        {
        ...
        public bool NextPlaneMaxLoadCapacityIsHigherThanCurrent()
        {
            Airport airport = new Airport(planes);
